        ...
        <div v-for="order in orders" :key="order._id" class="card bg-base-100 shadow-xl mb-6">
          <div class="card-body">
            ...
            <div class="mt-4 flex flex-wrap gap-2">
              <div v-for="(product, index) in getPreviewProducts(order)" :key="index" class="badge badge-outline">
              ...
              <table class="table w-full">
                ...
                <tfoot>
                  <tr>
                    ...
                    <td class="text-right font-semibold">{{ formatCurrency(selectedOrder.total_price) }} đ</td>
                  </tr>
                </tfoot>
              </table>
            </div>
              ...
              <div>
                ...
                <div class="flex items-center mt-2">
                  <div class="flex items-center">
                    <div class="badge badge-lg" :class="getStatusStepClass(selectedOrder.status, 'pending')">1</div>
                    <span class="mx-1">Chờ xác nhận</span>
                  </div>
                  <div class="w-4 h-0.5 bg-gray-300 mx-1"></div>
                  <div class="flex items-center">
                    <div class="badge badge-lg" :class="getStatusStepClass(selectedOrder.status, 'processing')">2</div>
                    <span class="mx-1">Đang xử lý</span>
                  </div>
                  <div class="w-4 h-0.5 bg-gray-300 mx-1"></div>
                  <div class="flex items-center">
                    <div class="badge badge-lg" :class="getStatusStepClass(selectedOrder.status, 'ordering')">3</div>
                    <span class="mx-1">Đang giao</span>
                  </div>
                  <div class="w-4 h-0.5 bg-gray-300 mx-1"></div>
                  <div class="flex items-center">
                    <div class="badge badge-lg" :class="getStatusStepClass(selectedOrder.status, 'completed')">4</div>
